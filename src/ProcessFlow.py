        ...
        if name_chman[names] == 'Staah':
            ...
            if '_OTA' in names:
                ...
                cmdata = pd.read_excel(
                    basepath + '\{}\{}\{}'.format('CM_Availability', tdayfold, names[:-4] + str('_CM.xlsx')),
                    skiprows=[1, 2], quoting=csv.QUOTE_NONE, error_bad_lines=False, encoding="latin1")
                pcdata = pd.read_excel(
                    basepath + '\{}\{}\{}'.format('Price_Calendar', tdayfold, names[:-4] + str('_PC.xlsx')))
                staahfile['Rooms'] = 1
                ...
                cmdata2 = pd.read_excel(
                    basepath + '\{}\{}\{}'.format('CM_Availability', tdayfold, names + str('_CM2.xlsx')),
                    quoting=csv.QUOTE_NONE, error_bad_lines=False, encoding="latin1")
                pcdata = pd.read_excel(
                    basepath + '\{}\{}\{}'.format('Price_Calendar', tdayfold, names + str('_PC.xlsx')))
                staahfile['Rooms'] = 1
