...
def total_ota_merging(htlname, ftr, iselldt, outcsvpath):        
    ...
    try:
        ...
        df_total['Date'] = pd.to_datetime(df_total['Date'])#a.s. jun23
    ...
    try:
        ...
        pass
    #--------------------------Last7 days update with df total------------------------------
    format3.iloc[:, 18:21] = df_total.iloc[:, 16:19]
    try:
        format3['LowestRate'] = format3['LowestRate'].astype(str).str.replace('.0', '')
        format3['LowestRate'] = format3['LowestRate'].astype(int)
    except:
        pass
    #==========================================================================
